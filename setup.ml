...
(* OASIS_START *)
(* DO NOT EDIT (digest: 16275d9b2da6743d8e3caae2c50733e9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Modelica abstract syntax and parser Modelica_ml is a Modelica frontend implemented in OCaml. It is written with compilation in mind, but should also be useful for other applications. Modelica.ml currently supports, abstract syntax, parsing, pretty printing and a form of lookup analysis (class normalization). Patches welcome!"
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "M\190\137J\240;\226\224h\007\237\176\190\237#l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

...
(* OASIS_START *)
(* DO NOT EDIT (digest: 924424a35ecf95d8f7c73de77b2fff47) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Generated_parser"; "Utils"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "parse_modelica.ml"});
               Executable
                 ({
                     cs_name = "parse_pkg";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "parse_package.ml"});
               Executable
                 ({
                     cs_name = "modclc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modclc.ml"});
               Executable
                 ({
                     cs_name = "modcl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modcl.ml"});
               Executable
                 ({
                     cs_name = "modclread";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modclread.ml"});
               Doc
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\218\007\225\252\199\239\249\177#\210\018)\027W\236d";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

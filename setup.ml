...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee18bb618654aa47211801ba01d6f0a3) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving_morphism", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "2\198C\163Z7\148\142\211\245k\245R\165\188&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

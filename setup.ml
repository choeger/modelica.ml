...
(* OASIS_START *)
(* DO NOT EDIT (digest: e523e3164d774e7711165c863753cbd0) *)
(*
...
let setup_t =
  {
     ...
     test =
       [
          ("Modelica Parser Tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$modelica_frontend_tests", []))];
     ...
     package =
       {
          ...
          authors =
            ["\"Christoph H\195\182ger <christoph.hoeger@tu-berlin.de>\""];
          homepage = Some "http://github.com/choeger/modelica.ml";
          synopsis = "Modelica abstract syntax and parser";
          description =
            Some
              [
                 OASISText.Para
                   "Modelica_ml is a Modelica frontend implemented in OCaml. It is written with compilation in mind, but should also be useful for other applications. Modelica_ml currently supports abstract syntax, parsing, pretty printing and a form of lookup analysis (class normalization). Patches welcome!"
              ];
          categories = [];
          ...
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_monadic", None);
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Generated_parser"];
               ...
               Executable
                 ({
                     cs_name = "modelica_frontend_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "modelica_frontend_tests.ml"
                   });
               Executable
                 ({
                     cs_name = "modml_clc";
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "modelica_ml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "modml_clc.ml"});
               Executable
                 ({
                     cs_name = "modlibc";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modlibc.ml"});
               Executable
                 ({
                     cs_name = "modlibdeps";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modlibdeps.ml"});
               Executable
                 ({
                     cs_name = "modml_parseall";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "parse_all.ml"});
               Executable
                 ({
                     cs_name = "dump_cl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "dump_cl.ml"});
               Executable
                 ({
                     cs_name = "modml_cl";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "modml_cl.ml"});
               Executable
                 ({
                     cs_name = "modml_clread";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "modml_clread.ml"});
               Doc
                 ({
                     cs_name = "modelica.ml-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for modelica.ml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\177\199\188i\161\231s\n\148J{\142Q\155\183\131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
